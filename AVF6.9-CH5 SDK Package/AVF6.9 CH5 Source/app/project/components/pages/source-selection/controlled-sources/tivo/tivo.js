...
const tivoModule = (function () {
    ...
    function setDisplayIndex(currentDisplayIndex) {
        showOnlyOneWidget("tivoKeysPanel1Index", currentDisplayIndex);
        showOnlyOneWidget("tivoNumberKeypadPanel1Index", currentDisplayIndex);
        showOnlyOneWidget("tivoColorButtonsIndex", currentDisplayIndex);
        showOnlyOneWidget("tivoKeysPanel2Index", currentDisplayIndex);
        showOnlyOneWidget("tivoPanelOneButtonTwoIndex", currentDisplayIndex);
    }
