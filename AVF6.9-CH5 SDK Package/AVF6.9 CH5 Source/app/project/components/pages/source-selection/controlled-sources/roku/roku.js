...
const rokuModule = (function () {
    ...
    function setDisplayIndex(currentDisplayIndex) {
        showOnlyOneWidget("rokuKeysPanel1Index", currentDisplayIndex);
        showOnlyOneWidget("rokuColorButtonsIndex", currentDisplayIndex);
        showOnlyOneWidget("rokuKeysPanel2Index", currentDisplayIndex);
    }
